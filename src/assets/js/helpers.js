export default {
    ...
    addVideoStream(elem, stream, partnerName) {
        elem.srcObject = stream;
        
        let videoContainer = document.createElement('div');
        videoContainer.className = 'video-container';
        
        let videoElement = elem;
        ...
        nameSpan.textContent = partnerName || 'User';
        ...
        maximizeBtn.title = 'View Fullscreen';
        maximizeBtn.onclick = (e) => {
            ...
            fullscreenPlayer.srcObject = stream;
